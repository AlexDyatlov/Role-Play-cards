...
$(function () {
    ...
    barba.hooks.beforeEnter(() => {
        $('.tab').on('click', function (e) {
            ...
            $(
                $(this).closest('.tabs-wrapper').siblings().find('div')
        ...
        $('.organization__item').on('click', function (e) {
            ...
            $(
                $(this).closest('.tabs-wrapper').siblings().find('div')
            ).removeClass('faction__content--active');
        ...
        $('.slider-inner').slick({
            ...
            slidesToScroll: 1,
            prevArrow:
                '<button class="slider-arrows slider-arrows__right"><img src="images/icons/arrow-left.svg" alt=""></button>',
            nextArrow:
                '<button class="slider-arrows slider-arrows__left"><img src="images/icons/arrow-right.svg" alt=""></button>',
        });
            ...
            item.addEventListener('click', () => {
                ...
                if (parent.classList.contains('cars__box--active')) {
                    ...
                    document
                        ...
                        .forEach(child =>
                            child.classList.remove('cars__box--active')
                        );
        ...
        const modelItemText = $('.modal__content-text');
        const modalItem = $('.modal__content-item');
        ...
        rouletteBtn.on('click', function () {
            ...
            const bgColorSelectedItem = selectedItem.css('background-image');
            ...
            modalItem.addClass('content__item');
            modalItem.addClass(`content__item-${color}`);
            modalItem.css( 'background-image',  bgColorSelectedItem);
            modalItemImage.attr(
                'src',
        ...
        modalClose.on('click', () => {
            ...
            modalItem.removeClass('content__item');
            modalItem.removeClass(`content__item-${color}`);
            modalItem.css( 'background-image',  '');
            color: '';
        });
